...
const Event = (props) => {
  ...
  return (
    <div className="max-w-[20rem] font-montserrat shadow-[0px_8px_5px_rgba(0,0,0,0.15)] rounded-xl hover:scale-[1.01] transition-all duration-300 bg-white overflow-hidden">
